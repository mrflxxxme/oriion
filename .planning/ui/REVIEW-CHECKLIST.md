...
- **Scope:** Wave 0 frontend PRs consuming `ui/design-tokens.md` + `ui/component-inventory.md`
...
- [ ] Read `ui/design-tokens.md` (token vocabulary)
- [ ] Read `ui/component-inventory.md` (allowed components)
...
- `ui/design-tokens.md` — token contracts
- `ui/component-inventory.md` — allowed components
- `ui/UI-DESIGN-PLAYBOOK.md` — designer workflow + ui-ux-pro-max invocation prompts (renamed from CLAUDE-DESIGN-PROMPTS.md per Session 4 / P-DESIGN-1)

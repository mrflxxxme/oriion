...
| [ADR-030](./ADR-030-telegram-business-api.md) | Telegram Business API integration (re-revision 2026-07-11 D-25: **Mini App = W2 фаза 02.12** — мобильный approval-фронт БЕЗ Business API; сам Business API = 01.11 parked RW-05 → W3; Stars billing W3+) |
...
| [ADR-041](./ADR-041-connector-architecture-native-tools.md) | Connector-архитектура: native-tool callables для НАШИХ коннекторов (01.9b); KMS creds-store + capability-gate + DLP-скрин исходящих; реальный MCP-протокол для чужих серверов = **W2 фаза 02.13** (re-revision 2026-07-11, D-26) |

...
| Wave 1 (Core MVP) | 🔄 **In progress** — Phase 01.1 Track A ✅ + **infra-PR MERGED** ([PR #51](https://github.com/mrflxxxme/oriion/pull/51), `fd02473`) + **01.1-retro AC-W1 hardening block ✅ VERIFIED-COMPLETE (scoped)** (#58–61 merged + post-merge audit-fix, [ADR-036](./decisions/ADR-036-outbox-relay-self-scheduling.md)); golden AC9+AC10 ✅ 3/3; **obs/IaC residual AC-W1-2/13/14/15 closed + live-proven in [PR #66](https://github.com/mrflxxxme/oriion/pull/66)**; worker-followups [PR #65](https://github.com/mrflxxxme/oriion/pull/65); **AC-W1-3 → Wave-2** (only deferred item) | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

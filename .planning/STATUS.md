...
| Wave 1 (Core MVP) | 🔄 **In progress** — 01.1-retro ✅ COMPLETE (#58–66); **01.2 Master-Agent core ✅** (ADR-029 Accepted, AC-W1-3); **01.3 Billing core ✅ code-complete (this PR)** — ADR-008 Wave-1 slice (tariffs+trial+caps+BYOK plumbing; ЮKassa→01.3b) | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

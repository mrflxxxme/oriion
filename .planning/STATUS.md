...
| Wave 1 (Core MVP) | 🔄 **In progress** — Phase 01.1 Track A ✅ + **infra-PR code-complete** (async Dramatiq dispatch + Redis-SSE; **AC8 RESOLVED by reframe** — dispatch p95 ≤1s gate + generation SLI); golden AC9+AC10 ✅ 3/3 | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

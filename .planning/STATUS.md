...
| Wave 1 (Core MVP) | 🔄 **In progress** — 01.1-retro ✅ COMPLETE (#58–66 merged); **PHASES.md регенерирован** (dependency-first 01.2→01.12); **Phase 01.2 Master-Agent core ✅ code-complete (this PR)** — ADR-029 **Accepted**, AC-W1-3 реализован (pulled из Wave-2 как фундамент вертикалей) | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

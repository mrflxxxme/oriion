...
| Wave 1 (Core MVP) | 🔄 **In progress** — Phase 01.1 Track A code-complete; golden on funded DeepSeek **AC9+AC10 ✅ 3/3, AC8 ❌ (p95 163s)** | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

...
| Wave 1 (Core MVP) | 🔄 **In progress** — 01.1-retro ✅ COMPLETE (#58–66); **01.2 Master-Agent core ✅** (ADR-029 Accepted, AC-W1-3); **01.3 Billing core ✅** (ADR-008 Wave-1 slice; ЮKassa→01.3b); **01.4 Memory ✅ code-complete (this PR)** — ADR-011 Wave-1 (cell+role memory + conversation history + «запомни»; filter-agent auto-trigger→01.4b) | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

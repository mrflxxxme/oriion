...
| Wave 1 (Core MVP) | 🔄 **In progress** — Phase 01.1 Track A ✅ + **infra-PR MERGED** ([PR #51](https://github.com/mrflxxxme/oriion/pull/51), `fd02473`, 2026-06-17 — async Dramatiq dispatch + Redis-SSE; **AC8 RESOLVED by reframe** — dispatch p95 ≤1s gate + generation SLI); golden AC9+AC10 ✅ 3/3; **остаётся founder post-merge action = staging 10× anchor / live-валидация** | Horizontal + 2 vertical (Marketing-agency + Telegram-крейтор) + Telegram Business API |

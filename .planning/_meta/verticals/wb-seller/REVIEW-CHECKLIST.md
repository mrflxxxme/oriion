...
- [ ] Frontmatter complete и валиден YAML (per [DECISION-11](../GRILL-DECISIONS-ORIION.md#decision-11) contract)
...
- [ ] `agent_archetype_slug` сопоставим с записью в `_meta/contracts/agents/` table

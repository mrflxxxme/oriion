...
## Высокоуровневые phase-направления Wave 1

| Phase | Направление | Owner | Релевантные ADR |
|---|---|---|---|
| 01.1 | Расширение каталога: +2 vertical-templates (Маркетинг-агентство РФ, Telegram-крейтор) к существующей WB-Селлер team | Senior Backend + Tech Lead | [ADR-017](../../decisions/ADR-017-vertical-templates.md), [ADR-022](../../decisions/ADR-022-coordinator-wizard-llm-hybrid.md) |
...
| 01.9 | Onboarding wizard (3 шага) + auto-spawn trial-cell + per-vertical demo-сценарии | Frontend + Founder | [ADR-022](../../decisions/ADR-022-coordinator-wizard-llm-hybrid.md), [ADR-016](../../decisions/ADR-016-team-first-ux.md) |
| 01.10 | Первые MCP-серверы (наши): telegram-mcp, yandex-disk-mcp, imap-smtp-mcp | Middle Backend | [ADR-013](../../decisions/ADR-013-mcp-protocol.md) |

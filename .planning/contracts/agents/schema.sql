...
-- Purpose: Bridge between authoring layer (`verticals/<slug>/prompts/*.md`)
...
-- `verticals/<vertical_slug>/prompts/<slug>.md` and pins its version.
-- ----------------------------------------------------------------------------
...
COMMENT ON COLUMN agent_archetypes.prompt_version IS
    'Must equal the `version:` field in frontmatter of `verticals/<vertical_slug>/prompts/<slug>.md`.';
